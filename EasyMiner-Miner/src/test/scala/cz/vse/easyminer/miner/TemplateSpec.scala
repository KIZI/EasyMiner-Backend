...
trait TemplateOpt extends ConfOpt {
  ...
  def rscript(tableName: String, selectQuery: String, defaultAppearance: String, consequent: Option[String], both: Option[String], interestMeasures: InterestMeasures) = {
