...
import org.scalatest.{Tag, Inspectors, FlatSpec, Matchers}
 ...
 */
class RestSpec extends FlatSpec with Matchers with Inspectors with ScalatestRouteTest with TemplateOpt {
